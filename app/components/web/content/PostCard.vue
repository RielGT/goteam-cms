...
<template>
  ...
  <!-- With-image variant: stacked (image on top, content below) -->
  <a
    v-else-if="variant === 'image'"
    :href="href"
    class="group flex flex-col rounded-2xl overflow-hidden border border-zinc-200 dark:border-white/10 bg-white dark:bg-zinc-900 shadow-soft hover:border-brand-purple transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-purple/40 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-ink"
  >
